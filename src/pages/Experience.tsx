...
const Experience = () => {
  return (
    <section className="content-center py-10" id="experience">

      <PageHeading title={"Year of experience"} describe={"Experience"} />

      <div className="ps-0 pb-6 mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-6">
        {experience.map((elem, index) => (
          <div key={index} className="relative group">
            <div className="bg-dark-lightBackground rounded-lg p-5 border border-primary/5 hover:border-primary/20 transition-all md:hover:scale-105 duration-300">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-medium dark:text-dark-Text text-light-text">
                  {elem.title}
                </h3>
              </div>
